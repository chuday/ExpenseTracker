...
extension Category {
    ...
    static let billsAndUtilities = Category(id: 2, name: "Billsn & Utilities", icon: .file_invoice_dollar)
    ...
    static let moviesAndDVDs = Category(id: 301, name: "Moviews & DVDs", icon: .film, mainCategoryId: 3)
    ...
    static let paycheqeu = Category(id: 701, name: "Paycheque", icon: .dollar_sign, mainCategoryId: 7)
